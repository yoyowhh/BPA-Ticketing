            ...
            <form action="/login" method="POST" class="mt-8 space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email"
                        ...
                        class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#8B1E1E]">
                </div>
