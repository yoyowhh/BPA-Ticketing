...
<head>
    ...
    <!-- Google Fonts: Poppins untuk replikasi font yang mirip -->
        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    colors: {
                        maroon: {
                            DEFAULT: '#8A1C22', // Warna merah marun tombol dan indikator sidebar
                            hover: '#6E1419'
                        },
                        bgSidebar: '#F8FAFC', // Latar belakang sidebar putih keabu-abuan halus
                    }
                }
            }
        }
...
<body class="bg-gray-50 font-sans min-h-screen flex">
    ...
    <aside class="w-64 bg-bgSidebar border-r border-gray-100 flex flex-col pt-12 pl-10 pr-4 shrink-0">
        <!-- Logo / Judul -->
        <h1 class="text-xl font-bold text-gray-900 mb-14 tracking-wide">BPA Ticketing</h1>
        
        <!-- Menu Navigasi -->
        <nav class="space-y-6">
            <a href="#" class="block text-gray-700 hover:text-gray-900 font-medium transition-colors">
                Beranda
            </a>
            
            <!-- Menu Aktif (Buat Tiket) dengan indikator garis merah di sebelah kiri -->
            <div class="relative -left-10 pl-10 flex items-center">
                <div class="w-1 h-7 bg-maroon rounded-r-md absolute left-0"></div>
                <a href="#" class="text-maroon font-semibold tracking-wide">
                    Buat Tiket
                </a>
            </div>
    ...
    <main class="flex-1 p-12 bg-white flex justify-start items-start overflow-y-auto">
        ...
        <!-- Container Form (Kotak Besar Berbuntut Lembut dengan Border Tipis) -->
        <div class="w-full max-w-4xl border border-gray-400 rounded-3xl p-10 bg-white">
            
            <h2 class="text-2xl font-bold text-gray-900 mb-2 tracking-wide">Buat Ticket Baru</h2>
            <p class="text-sm font-bold text-gray-900 mb-6">Data Penanya</p>
            
            <form action="#" method="POST" class="space-y-6">
                @csrf
                
                <!-- Baris 1: Nama dan NIM/NIP -->
                <div class="grid grid-cols-2 gap-8">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-800 mb-2">NIM/NIP</label>
                        <input type="text" name="nim_nip" placeholder="213424134" 
                            class="w-full border border-gray-400 rounded-2xl px-4 py-3.5 text-gray-700 placeholder-gray-400 focus:outline-none focus:border-maroon transition-colors">
                    </div>
                </div>

                <!-- Baris 2: Status dan Prodi / Unit -->
                <div class="grid grid-cols-2 gap-8">
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-800 mb-2">Prodi / Unit</label>
                        <input type="text" name="prodi_unit" placeholder="Alex Ferguson" 
                            class="w-full border border-gray-400 rounded-2xl px-4 py-3.5 text-gray-700 placeholder-gray-400 focus:outline-none focus:border-maroon transition-colors">
                    </div>
                </div>

                <!-- Baris 3: Kategori BPA -->
                <div>
                    <label class="block text-sm font-medium text-gray-800 mb-2">Kategori BPA</label>
                    <input type="text" name="kategori_bpa" 
